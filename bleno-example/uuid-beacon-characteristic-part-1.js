...
var jsonFile = {};
const propertyReadableWritable = "iBeaconUUID_1";
...
util.inherits(UuidIBeaconCharacteristicPart1, BlenoCharacteristic);

UuidIBeaconCharacteristicPart1.prototype.onReadRequest = function (
  offset,
  callback
) {
...
UuidIBeaconCharacteristicPart1.prototype.onWriteRequest = function (
  data,
  offset,
  withoutResponse,
  callback
...
module.exports = UuidIBeaconCharacteristicPart1;
