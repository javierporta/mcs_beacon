...
var jsonFile = {};
const propertyReadableWritable = "eddystoneUrl";
var EddystoneUrlCharacteristic = function () {
  EddystoneUrlCharacteristic.super_.call(this, {
    uuid: "abcd",
...
util.inherits(EddystoneUrlCharacteristic, BlenoCharacteristic);

EddystoneUrlCharacteristic.prototype.onReadRequest = function (
  offset,
  callback
) {
...
EddystoneUrlCharacteristic.prototype.onWriteRequest = function (
  data,
  offset,
  withoutResponse,
  callback
...
module.exports = EddystoneUrlCharacteristic;
